...
if(isset($_POST['editar'])){
    ...
    echo "<script>alert('Los datos han sido actulizados exitosamente');document.location='empleados.php'</script>";
}
  ...
  <div class="contenedor">
    ...
    <div class="parte-media">
        ...
        <div class="mb-1 col-12">
              ...
              <div class="mb-1 col-12">
                <label for="compañia" class="form-label">Dirección</label>
                <input 
                  type="text"
                  id="direccion"
                  name="direccion"
